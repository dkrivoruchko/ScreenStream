...
public class ExpansionHeader @JvmOverloads constructor(
    ...
    public fun addListener(listener: ExpansionLayout.Listener) {
        expansionLayout?.addListener(listener)
    }

    public fun removeListener(listener: ExpansionLayout.Listener) {
