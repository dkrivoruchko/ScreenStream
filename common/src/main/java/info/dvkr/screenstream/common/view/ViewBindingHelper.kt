...
public abstract class ViewBindingProperty<in R, T : ViewBinding>(
...
@Suppress("unused")
public fun <F : DialogFragment, T : ViewBinding> F.dialogViewBinding(viewBinder: (F) -> T): ViewBindingProperty<F, T> {
