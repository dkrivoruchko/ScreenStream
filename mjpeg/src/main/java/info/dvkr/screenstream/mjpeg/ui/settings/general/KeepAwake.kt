    ...
    Row(
        modifier = Modifier
            .toggleable(
                ...
                onValueChange = { scope.launch { withContext(NonCancellable) { mjpegSettings.updateData { copy(keepAwake = it) } } } }
            )
        ...
        Icon(
            ...
            contentDescription = stringResource(id = R.string.mjpeg_pref_keep_awake),
