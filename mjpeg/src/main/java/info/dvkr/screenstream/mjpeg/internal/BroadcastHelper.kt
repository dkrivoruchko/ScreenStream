...
internal sealed class BroadcastHelper(context: Context) {
    ...
    internal companion object {
        internal fun getInstance(context: Context): BroadcastHelper =
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) NougatBroadcastHelper(context)
            else LegacyBroadcastHelper(context)
    }
    ...
    internal fun startListening(onScreenOff: () -> Unit, onConnectionChanged: () -> Unit) {
