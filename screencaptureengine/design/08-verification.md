...
| `ACC-12` | sRGB, exact Display-P3 classification, precision-bounded Display-P3 output, unsupported wide/HDR action, and the selected diagnostic site. | `H-GM`, `A-GL`, `H-OB` | [Product color](01-product-contract.md#5-dimensions-transform-color-and-jpeg-semantics), [Capture color actions](04-capture-rendering.md#dataspace-and-shader-color-actions) |
