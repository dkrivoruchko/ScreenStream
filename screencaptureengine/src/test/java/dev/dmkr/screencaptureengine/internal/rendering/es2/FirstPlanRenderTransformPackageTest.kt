...
class FirstPlanRenderTransformPackageTest {
    ...
    private fun concreteOesMatrixStorageFieldPaths(): List<String> {
        val source = Files.readString(
            resolveSourcePath(
                rootRelativePath = "screencaptureengine/src/main/java/dev/dmkr/screencaptureengine/internal/rendering/es2/FirstPlanRenderTransformPackage.kt",
                moduleRelativePath = "src/main/java/dev/dmkr/screencaptureengine/internal/rendering/es2/FirstPlanRenderTransformPackage.kt",
            ),
        )
