...
class SettingsFragment : Fragment(R.layout.fragment_settings) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenCreated {
            when (appSettings.streamModeFlow.first()) {
                AppSettings.Values.STREAM_MODE_WEBRTC -> {
                    binding.vpFragmentSettings.adapter = object : FragmentStateAdapter(this@SettingsFragment) {
                    ...
                    binding.tlFragmentSettings.visibility = View.GONE
                }
