...
import info.dvkr.screenstream.rtsp.ui.main.mode.ClientMode
import info.dvkr.screenstream.rtsp.ui.main.mode.ServerMode

@Composable
internal fun ModeCard(
    sendEvent: (RtspEvent) -> Unit,
    selectedMode: RtspSettings.Values.Mode,
    onModeSelected: (RtspSettings.Values.Mode) -> Unit,
    isStreaming: Boolean,
    ...
    ElevatedCard(modifier = modifier) {
        Box(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                when (selectedMode) {
                    RtspSettings.Values.Mode.SERVER -> ServerMode(
